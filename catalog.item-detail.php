...
<?if (CSite::InGroup(array(8))){?>
				<div class="switch-block"><p style="display:none;font-size:14px;margin-left: 10px;" class="getPricesWindow">Показать розничные цены</p><p class="base-price-p" style="margin-left: 10px;">Показать оптовые цены</p><div class="switch-btn" data-id="#base-price" style="margin: 10px;"></div></div>
<?}?>
